...
class Dimensions {
  ...
  static double appMargin = screenSizeWidth > WEB_MAX_WIDTH
      ? MARGIN_SIZE_EXTRA_LARGE
      : screenSizeWidth / 18.75;
  static double sizedBoxHeight =
      screenSizeWidth > WEB_MAX_WIDTH ? 20 : screenSizeWidth / 12.5;
  static double viewPort =
      screenSizeWidth > WEB_MAX_WIDTH ? VIEW_PORT_DESKTOP : VIEW_PORT_MOBILE;
  static double listViewImg = screenSizeWidth > WEB_MAX_WIDTH
      ? LIST_VIEW_CON_SIZE_DESKTOP
      : screenSizeWidth / 3.12;

  static double listViewCon = screenSizeWidth > WEB_MAX_WIDTH
      ? LIST_VIEW_CON_SIZE_DESKTOP - 40
      : screenSizeWidth / 3.75;
  ...
  static double pageViewCon = screenSizeWidth > WEB_MAX_WIDTH
      ? PAGE_VIEW_CON_DESK
      : screenSizeHeight / 2.64;

  static double pageViewInnerCon =
      screenSizeWidth > WEB_MAX_WIDTH ? PAGE_VIEW_CON : screenSizeHeight / 3.83;
  static double pageViewInnerConText = screenSizeWidth > WEB_MAX_WIDTH
      ? PAGE_VIEW_CON_TEXT
      : screenSizeHeight / 7.03;

  //detail food
  static const double DETAIL_FOOD_IMG = 400;

  static double detailFoodImg = screenSizeWidth > WEB_MAX_WIDTH
      ? double.maxFinite - 400
      : screenSizeHeight / 2.11;
  static double detailFoodImgWidth = screenSizeWidth > WEB_MAX_WIDTH
      ? double.maxFinite - 400
      : double.maxFinite;
  static double detailFoodImgPad =
      screenSizeWidth > WEB_MAX_WIDTH ? MARGIN_SIZE_EXTRA_LARGE : 0;
  ...
  static double moreViewCon = screenSizeWidth > WEB_MAX_WIDTH
      ? PAGE_VIEW_CON_DESK
      : screenSizeHeight / 2.64;

  static double moreViewInnerCon =
      screenSizeWidth > WEB_MAX_WIDTH ? PAGE_VIEW_CON : screenSizeHeight / 3.83;
  static double moreViewInnerConText = screenSizeWidth > WEB_MAX_WIDTH
      ? PAGE_VIEW_CON_TEXT
      : screenSizeHeight / 7.03;
  ...
  static double topBar =
      screenSizeWidth > WEB_MAX_WIDTH ? TOP_BAR_WEB : TOP_BAR_MOB;
  //bottom buttons
  static const double BUTTOM_BUTTON_CON = 120;
  static double buttonButtonCon = screenSizeWidth > WEB_MAX_WIDTH
      ? BUTTOM_BUTTON_CON
      : screenSizeHeight / 6.63;
  ...
  static double SPLASH_IMG_WIDTH1 = screenSizeWidth > WEB_MAX_WIDTH ? 350 : 200;
  static const double PADDING_SIZE_LARGE = 20.0;
  static const double PADDING_SIZE_LARGE1 = 10.0;
  //dynamic padding
  ...
  static double padding5 = screenSizeWidth > WEB_MAX_WIDTH
      ? PADDING_SIZE_5
      : screenSizeHeight / 168.8;
  static double padding20 = screenSizeWidth > WEB_MAX_WIDTH
      ? PADDING_SIZE_20
      : screenSizeHeight / 42.2;
  static double padding30 = screenSizeWidth > WEB_MAX_WIDTH
      ? PADDING_SIZE_30
      : screenSizeHeight / 28.13;
  static double padding40 = screenSizeWidth > WEB_MAX_WIDTH
      ? PADDING_SIZE_40
      : screenSizeHeight / 21.10;
  static double padding10 = screenSizeWidth > WEB_MAX_WIDTH
      ? PADDING_SIZE_SMALL
      : screenSizeHeight / 84.4;
  ...
  static double margin40 = screenSizeWidth > WEB_MAX_WIDTH
      ? MARGIN_SIZE_40
      : screenSizeHeight / 21.1;
  static double margin80 = screenSizeWidth > WEB_MAX_WIDTH
      ? MARGIN_SIZE_80
      : screenSizeHeight / 10.55;
  static double margin35 = screenSizeWidth > WEB_MAX_WIDTH
      ? MARGIN_SIZE_35
      : screenSizeHeight / 24.11;

  //dynamic font
  static double font18 =
      screenSizeWidth > WEB_MAX_WIDTH ? 18 : screenSizeHeight / 70.33;
  static double font20 = screenSizeWidth > WEB_MAX_WIDTH
      ? screenSizeHeight / 32.46
      : screenSizeHeight / 42.2;
  static double font22 =
      screenSizeWidth > WEB_MAX_WIDTH ? 22 : screenSizeHeight / 38.36;
  static double font26 =
      screenSizeWidth > WEB_MAX_WIDTH ? 26 : screenSizeHeight / 32.46;
  static double font30 =
      screenSizeWidth > WEB_MAX_WIDTH ? 30 : screenSizeHeight / 28.13;
  ...
  static double sliverHeight =
      screenSizeWidth > WEB_MAX_WIDTH ? SLIVER_HEIGHT : screenSizeHeight / 2.41;
  static double sliverImg =
      screenSizeWidth > WEB_MAX_WIDTH ? SLIVER_IMG : screenSizeHeight / 2.81;
  static double sliverDec =
      screenSizeWidth > WEB_MAX_WIDTH ? SLIVER_DEC : screenSizeHeight / 16.88;

  static const double ICON_BACK_SIZE = 50;
  static double iconBackSize = screenSizeWidth > WEB_MAX_WIDTH
      ? ICON_BACK_SIZE
      : screenSizeHeight / 16.88;

  static const double BORDER_RADIUS_15 = 15;
  static double borderRadius15 = screenSizeWidth > WEB_MAX_WIDTH
      ? BORDER_RADIUS_15
      : screenSizeHeight / 56.27;

  //dynamic buttom buttons
  static const double BUTTOM_BUTTON = 120;
  static double buttomButton =
      screenSizeWidth > WEB_MAX_WIDTH ? 150 : screenSizeHeight / 7.03;
  //new hight
  ...
  static double height250 = screenSizeHeight / 3.379;
  static double height195 = screenSizeHeight / 4.4;
  static double height55 = screenSizeHeight / 15.34;
  ...
  static double width180 = screenSizeHeight / 4.7;
