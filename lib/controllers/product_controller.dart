...
class ProductController extends GetxController {
  ...
  String _selected_size = 'null';
  String get selected_size => _selected_size;
  ...
  void addItem(Product product) {
    _cart.addItem(product, _quantity, _selected_size);
    _quantity = 0;
    _selected_size = 'null';
  ...
  void setSize(var selected_size, Product product) {
    /*
