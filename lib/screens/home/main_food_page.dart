                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: TextWidget(text: "What most people prefer", color: AppColors.textColor)
                    ),
                  ],
                )
            ),
                          ...
                          child:  Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CachedNetworkImage(
                                  imageUrl:  AppConstants.UPLOADS_URL+popularProducts.popularProductList[index].img,
                                  imageBuilder: (context, imageProvider) => Container(
                                    width: Dimensions.listViewImg,
                                    height: Dimensions.listViewImg,
                                    decoration: BoxDecoration(
                                    ...
                                    child:Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: Dimensions.padding10,),
                                          TextWidget(text: "Going with the anime trends", color: AppColors.textColor),
                                          SizedBox(height: Dimensions.padding10,),
                                          Row(
                                            mainAxisAlignment:MainAxisAlignment.spaceBetween,
                                            children: [
                                              IconAndTextWidget(text: "1000", color: AppColors.textColor, icon: Icons.currency_rupee_rounded, iconColor: AppColors.mainBlackColor,),
