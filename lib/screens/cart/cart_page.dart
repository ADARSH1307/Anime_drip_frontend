 ...
 void checkNewVersion(NewVersionPlus newVersion) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                                            ...
                                                            BigText(
                                                                text: "\₹ " +
                                                                    cartController
                                                                        ...
                                                                        .price
                                                                        .toString(),
                                                                color: Color.fromARGB(255, 150, 27, 150)),
                                                            SizedBox(
                                                              width: Dimensions
                                                                  .padding10,
                                                            ),
      ...
      return SizedBox.shrink(); // Return an empty SizedBox for zero quantity items
    }
                                }),
                          );
                        }),
                    ...
                    return Get.find<CartController>().getCarts.length > 0
                        ? Column(
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: CommonTextButton(
                                      text: "payment_and_delivery_options".tr),
                                ),
                              ),
                              Row(
                                children: [
                           ...
                           */
                                        ...
                                        var amount = Get.find<CartController>()
                                            .totalAmount
                                            .toString();
                                        var options = {
