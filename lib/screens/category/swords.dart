...
class SwordsItemsPage extends StatefulWidget {
  const SwordsItemsPage({Key? key}) : super(key: key);

  @override
  State<SwordsItemsPage> createState() => _SwordsItemsPageState();
}

class _SwordsItemsPageState extends State<SwordsItemsPage> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            GetBuilder<Swords>(builder: (pantProduct) {
              return Row(
                //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            Get.toNamed(RouteHelper.getKatanaRoute(index, "category"));
                          },
                          child: Container(
                            child: Row(
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(
                                          AppConstants.UPLOADS_URL + pantProduct.swordsList[index].img),
                                    ),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            BigText(
                                              text: pantProduct.swordsList[index].title,
