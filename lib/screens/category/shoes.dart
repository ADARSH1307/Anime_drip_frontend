...
class ShoesItemsPage extends StatefulWidget {
  const ShoesItemsPage({Key? key}) : super(key: key);

  @override
  State<ShoesItemsPage> createState() => _ShoesItemsPageState();
}

class _ShoesItemsPageState extends State<ShoesItemsPage> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            GetBuilder<Shoes>(builder: (pantProduct) {
              return Row(
                //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            Get.toNamed(RouteHelper.getShoesRoute(index, "category"));
                          },
                          child: Container(
                            child: Row(
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(
                                          AppConstants.UPLOADS_URL + pantProduct.shoeList[index].img),
                                    ),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            BigText(
                                              text: pantProduct.shoeList[index].title,
