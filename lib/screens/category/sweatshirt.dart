...
class SweatshirtItemsPage extends StatefulWidget {
  const SweatshirtItemsPage({Key? key}) : super(key: key);

  @override
  State<SweatshirtItemsPage> createState() => _SweatshirtItemsPageState();
}

class _SweatshirtItemsPageState extends State<SweatshirtItemsPage> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            GetBuilder<Sweatshirt>(builder: (pantProduct) {
              return Row(
                //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            Get.toNamed(RouteHelper.getSweatshirtRoute(index, "category"));
                          },
                          child: Container(
                            child: Row(
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(
                                          AppConstants.UPLOADS_URL + pantProduct.sweatshirtList[index].img),
                                    ),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            BigText(
                                              text: pantProduct.sweatshirtList[index].title,
