...
class PantItemsPage extends StatefulWidget {
  const PantItemsPage({Key? key}) : super(key: key);

  @override
  State<PantItemsPage> createState() => _PantItemsPageState();
}

class _PantItemsPageState extends State<PantItemsPage> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            GetBuilder<Pant>(builder: (pantProduct) {
              return Row(
                children: [
                  Expanded(
                                    ...
                                    image: DecorationImage(
                                        ...
                                        image: NetworkImage(
                                            AppConstants.UPLOADS_URL +
                                                pantProduct.pantList[index].img)),
