...
class HoodieItemsPage extends StatefulWidget {
  const HoodieItemsPage({Key? key}) : super(key: key);

  @override
  State<HoodieItemsPage> createState() => _HoodieItemsPageState();
}

class _HoodieItemsPageState extends State<HoodieItemsPage> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            GetBuilder<Hoodie>(builder: (pantProduct) {
              return Row(
                //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Expanded(
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(
                                          AppConstants.UPLOADS_URL + pantProduct.hoodieList[index].img),
                                    ),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            BigText(
                                              text: pantProduct.hoodieList[index].title,
