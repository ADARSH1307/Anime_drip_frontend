...
class ShirtsDetail extends StatefulWidget {
  int pageId;
  String page;
  ShirtsDetail({Key? key, required this.pageId, required this.page})
      : super(key: key);

  @override
  State<ShirtsDetail> createState() => _ShirtsDetailState();
}

class _ShirtsDetailState extends State<ShirtsDetail> {
  int activeIndex = 0;
  bool isMore = false;
  ...
  Widget build(BuildContext context) {
    ...
    var productItem =
        Get.find<Shirt>().shirtList[widget.pageId];
