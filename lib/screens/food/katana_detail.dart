...
class KatanaDetail extends StatefulWidget {
  int pageId;
  String page;
  KatanaDetail({Key? key, required this.pageId, required this.page})
      : super(key: key);

  @override
  State<KatanaDetail> createState() => _KatanaDetailState();
}

class _KatanaDetailState extends State<KatanaDetail> {
  int activeIndex = 0;
  bool isMore = false;
  ...
  Widget build(BuildContext context) {
    ...
    var productItem =
        Get.find<Swords>().swordsList[widget.pageId];
