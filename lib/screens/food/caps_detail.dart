...
class CapDetail extends StatefulWidget {
  int pageId;
  String page;
  CapDetail({Key? key, required this.pageId, required this.page})
      : super(key: key);

  @override
  State<CapDetail> createState() => _CapDetailState();
}

class _CapDetailState extends State<CapDetail> {
  int activeIndex = 0;
  bool isMore = false;
