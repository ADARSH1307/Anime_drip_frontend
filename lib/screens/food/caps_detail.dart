...
class CapsDetail extends StatefulWidget {
  int pageId;
  String page;
  CapsDetail({Key? key, required this.pageId, required this.page})
      : super(key: key);

  @override
  State<CapsDetail> createState() => _CapsDetailState();
}

class _CapsDetailState extends State<CapsDetail> {
  int activeIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    var productItem =
        Get.find<Caps>().capsList[widget.pageId];
