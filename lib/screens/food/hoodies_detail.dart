...
class HoodiesDetail extends StatefulWidget {
  int pageId;
  String page;
  HoodiesDetail({Key? key, required this.pageId, required this.page})
      : super(key: key);

  @override
  State<HoodiesDetail> createState() => _HoodiesDetailState();
}

class _HoodiesDetailState extends State<HoodiesDetail> {
  int activeIndex = 0;
  bool isMore = false;
  ...
  Widget build(BuildContext context) {
    ...
    var productItem = Get.find<Hoodie>().hoodieList[widget.pageId];
