...
class PantDetail extends StatefulWidget {
  int pageId;
  String page;
  PantDetail({Key? key, required this.pageId, required this.page})
      : super(key: key);

  @override
  State<PantDetail> createState() => _PantDetailState();
}

class _PantDetailState extends State<PantDetail> {
  int activeIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    var productItem =
        Get.find<Pant>().pantList[widget.pageId];
