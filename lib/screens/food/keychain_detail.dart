...
class KeychainDetail extends StatefulWidget {
  int pageId;
  String page;
  KeychainDetail({Key? key, required this.pageId, required this.page})
      : super(key: key);

  @override
  State<KeychainDetail> createState() => _KeychainDetailState();
}

class _KeychainDetailState extends State<KeychainDetail> {
  int activeIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    var productItem =
        Get.find<Keychain>().keychainList[widget.pageId];
